...
# Основна різниця полягає в тому, що генераторні вирази створюють генератор і ефект ивні з точки зору використання пам'яті, оскільки генерують значення "по запиту". Списки генераторів створюють списки і витрачають пам'ять на зберігання всіх значень одразу. 
