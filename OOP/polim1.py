# Поліморфізм - це можливість оброблення різних об'єктів шляхом використання одного й того ж самого методу по назві. 
# Поліморфізм - це концепція об'єктно-орієнтованого програмування, яка дозволяє об'єктам різних класів виконувати одну і ту ж операцію. 
# В Python поліморфізм виявляється через можливість використання методів з однаковим іменем, але реалізованих у різних класах.
